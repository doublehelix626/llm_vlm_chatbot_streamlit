...
def simple_image_chat(use_stream=True, img_path=None):
    ...
    messages = [
        ...
        {
            "role": "assistant",
            "content": "The image displays a wooden boardwalk extending through a vibrant green grassy wetland. The "
                       "sky is partly cloudy with soft, wispy clouds, indicating nice weather. Vegetation is seen on "
                       "either side of the boardwalk, and trees are present in the background, suggesting that this "
                       "area might be a natural reserve or park designed for ecological preservation and outdoor "
                       "recreation. The boardwalk allows visitors to explore the area without disturbing the natural "
                       "habitat.",
        },
        {
            "role": "user",
    ...
    for content in create_chat_completion("cogvlm-chat-17b", messages=messages, use_stream=use_stream):
        return content
